...
class SessionsLegalPage extends ConsumerStatefulWidget {
  const SessionsLegalPage({super.key});

  @override
  ConsumerState<SessionsLegalPage> createState() => _SessionsLegalPageState();
}

class _SessionsLegalPageState extends ConsumerState<SessionsLegalPage> {
  @override
  void initState() {
    super.initState();
      ...
      if (token != null && profileId != null) {
        ref
            ...
            .loadSessions(
              page: 0,
              size: 20,
              legalResponsibleId: profileId.toString(),
            );
      }
    });
  }
